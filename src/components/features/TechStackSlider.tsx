            ...
            >
                {[...TECHNOLOGIES, ...TECHNOLOGIES].map((tech, i) => (
                    <div key={i} className="flex items-center gap-2 group cursor-default">
                        <span className="w-1.5 h-1.5 rounded-full bg-neutral-800 group-hover:bg-[#10B981] transition-colors" />
                        <span className="text-neutral-400 font-mono text-sm uppercase tracking-widest group-hover:text-[#34D399] transition-colors">
                            {tech}
                        </span>
                    </div>
                ))}
